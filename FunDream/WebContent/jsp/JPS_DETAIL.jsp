						...
						<div class="pv-comment-card">
							...
							<div id="replyBox">
								...
								<div id='buttonBox'>
									...
									<c:if test="${type eq 'producer'}">
									<button onclick="window.open('JCE_REPORTFORM.do?c_index=${comment.c_index}&p_index=${comment.p_index}', 
						...
						<div class="creator-sponsors1">
							...
							<ul class="skill-list">
								...
								<li class="skill">
									...
									${l.r_name } (<span id="amt${status.index}">${l.fd_amt}</span> 개)<br><span id="v_per${status.index}"></span>%
