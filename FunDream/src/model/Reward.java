...
public class Reward {
	...
	public Reward(int r_index, int p_index, int m_id, int r_price, String r_name, String r_img, String r_contents,
			int ct_index, Timestamp r_start, String r_option, int r_del, int r_amt) {
		this.r_index = r_index;
		this.p_index = p_index;
		this.m_id = m_id;
		this.r_price = r_price;
